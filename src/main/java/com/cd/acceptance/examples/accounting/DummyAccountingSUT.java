...
public class DummyAccountingSUT {
    ...
    private final ExternalKYCCheck kycCheck;
    ...
    public void submitInvoice(String userName, Invoice invoice) throws UserAccessDeniedException {
        User user = verifyAccessForUser(userName, UserRole.Submitter);
        SubmittedInvoice submittedInvoice = new SubmittedInvoice(user, invoice);
